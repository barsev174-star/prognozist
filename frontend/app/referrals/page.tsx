...
const heroBody = "\u041f\u043e\u0434\u0435\u043b\u0438\u0442\u0435\u0441\u044c \u043f\u0435\u0440\u0441\u043e\u043d\u0430\u043b\u044c\u043d\u043e\u0439 \u0441\u0441\u044b\u043b\u043a\u043e\u0439, \u0437\u043e\u0432\u0438\u0442\u0435 \u0434\u0440\u0443\u0437\u0435\u0439 \u0432 Prognozist \u0438 \u0441\u043b\u0435\u0434\u0438\u0442\u0435, \u043a\u0430\u043a \u0440\u0430\u0441\u0442\u0435\u0442 \u0432\u0430\u0448\u0435 \u0441\u043e\u043e\u0431\u0449\u0435\u0441\u0442\u0432\u043e.";
...
const shareOpenedText = "\u041e\u0442\u043a\u0440\u044b\u043b\u0438 Telegram \u0434\u043b\u044f \u0432\u044b\u0431\u043e\u0440\u0430 \u0430\u0434\u0440\u0435\u0441\u0430\u0442\u0430.";
...
const shareHintText =
  "\u041e\u0442\u043f\u0440\u0430\u0432\u043b\u044f\u0439\u0442\u0435 \u044d\u0442\u0443 \u0441\u0441\u044b\u043b\u043a\u0443 \u0432 Telegram: \u0441\u043d\u0430\u0447\u0430\u043b\u0430 \u043e\u0442\u043a\u0440\u043e\u0435\u0442\u0441\u044f \u0431\u043e\u0442, \u0430 \u0443\u0436\u0435 \u0438\u0437 \u043d\u0435\u0433\u043e \u0434\u0440\u0443\u0433 \u0437\u0430\u0439\u0434\u0435\u0442 \u0432 Mini App \u0431\u0435\u0437 \u043b\u0438\u0448\u043d\u0435\u0433\u043e \u0431\u0440\u0430\u0443\u0437\u0435\u0440\u0430.";
...
function ReferralsContent() {
  ...
  const preferredLink = state.status === "ready" ? buildPreferredReferralLink(state.data.referral_link) : "";
  ...
  return (
    <main className="mx-auto flex max-w-md flex-col gap-4 px-4 py-5">
      ...
      <section className="rounded-[24px] border border-black/5 bg-white/92 p-4 shadow-[0_10px_30px_rgba(23,32,51,0.08)]">
        ...
        {state.status === "ready" ? (
          <>
            <div className="mt-4 rounded-[20px] bg-[rgba(23,32,51,0.04)] px-4 py-3 text-sm text-ink break-all">{preferredLink}</div>
            ...
            <p className="mt-4 text-sm text-muted">{shareHintText}</p>
            <div className="mt-4 flex flex-wrap gap-2">
              <button className="rounded-full bg-ink px-4 py-2 text-sm font-medium text-white" type="button" onClick={() => shareLink(preferredLink)}>
                {shareLabel}
              </button>
              <button className="rounded-full border border-black/10 bg-white px-4 py-2 text-sm font-medium text-ink" type="button" onClick={() => copyLink(preferredLink)}>
                {copyLabel}
              </button>
            </div>
...
function buildPreferredReferralLink(rawLink: string): string {
  ...
  try {
    ...
    return `https://t.me/${botUsername}?start=${encodeURIComponent(startApp)}`;
  } catch {
    return rawLink;
  }
}
